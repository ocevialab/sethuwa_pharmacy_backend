...
namespace pharmacyPOS.API.Migrations
{
    ...
    [Migration("20260720142854_AddPurchaseItemLinkToStock")]
    partial class AddPurchaseItemLinkToStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pharmacyPOS.API.Models.EmployeePermission", b =>
                {
                    b.Property<long>("EmployeePermissionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasColumnName("EmployeePermissionId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("EmployeePermissionId"));
                    ...
                    b.HasKey("EmployeePermissionId")
                        .HasName("PK__Employee__E736E75DED98206C");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_EmployeePermissions_EmployeeId")
                        .HasFilter("([IsActive]=(1))");

                    b.HasIndex(new[] { "PermissionId" }, "IX_EmployeePermissions_PermissionId")
                        .HasFilter("([IsActive]=(1))");

                    b.HasIndex(new[] { "EmployeeId", "PermissionId" }, "UQ_EmployeePermission")
                        .IsUnique();
            ...
            modelBuilder.Entity("pharmacyPOS.API.Models.Permission", b =>
                {
                    ...
                    b.HasKey("PermissionId")
                        .HasName("PK__Permissi__EFA6FB2F54018878");

                    b.HasIndex(new[] { "Module" }, "IX_Permissions_Module")
                        .HasFilter("([IsActive]=(1))");
            ...
            modelBuilder.Entity("pharmacyPOS.API.Models.SalesItem", b =>
                {
                    ...
                    b.HasOne("pharmacyPOS.API.Models.Stock", "Stock")
                        .WithMany()
            ...
            modelBuilder.Entity("pharmacyPOS.API.Models.Stock", b =>
                {
                    ...
                    b.HasOne("pharmacyPOS.API.Models.PurchaseItem", "PurchaseItem")
                        .WithMany("Stocks")
